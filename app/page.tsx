...
const aiFeatures = [
  {
    title: 'AI Messaging',
    description: 'Instant AI generated suggested replies to guest messages',
  ...
  {
    title: 'AI Tasks',
    description: 'Automatically generate maintenance tasks from messages and reviews',
  ...
  {
    title: 'Cleanings',
    description: 'Automatically schedule turnover cleanings',
  ...
  {
    title: 'Ask AI',
    description: 'Always-on hosting assistant for any question',
  ...
  {
    title: 'AI Reviews',
    description: 'Auto-detect tasks from reviews and write reviews for guests',
  ...
  {
    title: 'AI Guidebooks',
    description: 'Digital guidebooks with AI assistance',
  ...
  {
    title: 'AI Memory',
    description: 'Continuously learning AI that remembers everything',
  ...
  {
    title: 'AI Autopilot',
    description: '24/7 coverage for guest messages with smart escalation',
