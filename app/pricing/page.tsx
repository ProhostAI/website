...
const plans = [
  {
    ...
    minimumMonthly: 30,
    features: [
      'Unlimited AI replies to each guest message',
      'AI Messaging Autopilot - 24/7 coverage',
      'Automated maintenance task management',
      'Automated cleaning scheduling & coordination',
      'AI Memory - self-improving personalized AI',
      'AI Reviews - analyze & write guest reviews',
  ...
  },
  {
    ...
    features: [
      ...
      'Upload PDFs, images & text for AI',
