...
export const metadata: Metadata = {
  title: 'Privacy Policy - ProhostAI',
  description: 'ProhostAI Privacy Policy - Learn how we collect, use, and protect your personal information.',
};
              ...
              <div className="prose prose-gray max-w-none">
                <section className="mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Prohost AI, Inc. operates the prohost.ai website, the ProhostAI web application,
                    mobile application(s), and other associated services ("Service").
                  </p>
                  <p className="text-gray-600 mb-4">
                    This page is used to inform website visitors regarding our policies with the collection,
                    use, and disclosure of Personal Information if anyone decided to use this Service and/or
                    the prohost.ai website.
                  </p>
                  <p className="text-gray-600 mb-4">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    which is accessible at www.prohost.ai, unless otherwise defined in this Privacy Policy.
                  </p>

                  <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Information Collection and Use</h3>
                  <p className="text-gray-600 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Log Data</h3>
                  <p className="text-gray-600 mb-4">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    hard drive. Our website uses these "cookies" to collection information and to improve our Service.
                    You have the option to either accept or refuse these cookies, and know when a cookie is being sent
                    to your computer. If you choose to refuse our cookies, you may not be able to use some portions
                    of our Service.
                  </p>
                </section>
